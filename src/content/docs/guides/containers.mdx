...
:::note
When you create a database, key-value store or object storage using an Agnost template you can retrieve the username and password credentials to access these resource from the [environment variables](/guides/variables) tab of the container.
:::
