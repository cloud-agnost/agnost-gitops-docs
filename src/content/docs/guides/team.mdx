...
---
Agnost includes robust team management features to help you manage both organizations and projects effectively. This section outlines the roles and permissions for organization and project members. By defining clear roles and permissions, the platform ensures that each member of your organization and projects has access to the resources they need while maintaining the necessary controls and oversight.
...
:::note
Please note that organization invitations can be used only once. In order for an organization invitation link to work, your Agnost cluter needs to be publicly accessible, namely you need to set the doman name of your cluster. Please see [Post-Installation](../set-up/customization) configuration steps for more information on how to set your cluster domain.
:::
